...
export const zR2ResultInfo = z.record(z.string(), z.unknown());
	...
	results: z
		.object({
			...
			rows: z
				.array(
					z.array(
						z.union([z.number(), z.string(), z.record(z.string(), z.unknown())])
					)
				)
				.optional(),
		})
...
export const zR2Object = z.object({
	...
	http_metadata: z.record(z.string(), z.string()).optional(),
...
export const zWorkersKvAnyWritable = z
	.union([
		z.string(),
		z.number(),
		z.int(),
...
export const zR2BucketListObjectsData = z.object({
	...
	query: z
		.object({
			...
			cursor: z.string().optional(),
			per_page: z.int().optional().default(1000),
		})
		.optional(),
});
