				...
				get: {
					...
					responses: {
						"200": {
										...
										allOf: [
											...
											},
											{
												properties: {
													result: {
														items: {
															$ref: "#/components/schemas/flagship_app",
														},
														type: "array",
													},
												},
							...
							description: "List Flagship Apps response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "List Flagship Apps response failure.",
						},
					},
				...
				get: {
					...
					responses: {
						"200": {
							...
							description: "List Flagship Flags response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "List Flagship Flags response failure.",
						},
					},
				...
				post: {
					...
					responses: {
						"200": {
							...
							description: "Create Flagship Flag response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "Create Flagship Flag response failure.",
						},
					},
				...
				get: {
					...
					responses: {
						"200": {
							...
							description: "Get Flagship Flag response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "Get Flagship Flag response failure.",
						},
					},
					summary: "Get Flagship Flag",
					tags: ["Flagship"],
				},
				patch: {
					description:
					...
					responses: {
						"200": {
							...
							description: "Update Flagship Flag response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "Update Flagship Flag response failure.",
						},
					},
				...
				delete: {
					...
					responses: {
						"200": {
							...
							description: "Delete Flagship Flag response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "Delete Flagship Flag response failure.",
						},
					},
				...
				post: {
					...
					responses: {
						"200": {
							...
							description: "Evaluate Flagship Flag response.",
						},
						"4XX": {
							content: {
								"application/json": {
							...
							description: "Evaluate Flagship Flag response failure.",
						},
					},
